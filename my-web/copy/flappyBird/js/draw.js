define(function(require, exports, module){
	...
	// 由于该模块依赖gameScene.js和overSecne.js两个
	// 模块，所以先将这两个模块引入

	var getGameScene = require('./gameScene.js');
	var getOverScene = require('./overScene.js');
    ...
    function draw(imgObj) {
        ...
        // 动画帧函数requestAnimationFrame()其实就和setTimeout()一样，只不过，requestAnimationFrame()只需要传递回调函数即可，不需要传递时间，因为时间是由浏览器来控制的。此时动画的性能就和计算机的性能以及
        // 浏览器的工作负荷相关。
