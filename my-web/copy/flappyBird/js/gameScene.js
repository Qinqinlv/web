define(function(require , exports , module){
    ...
    // 这个模块需要用到4个具体的场景，需要引入bird.js,
    // land.js,pipe.js,sky.js这4个场景
    var getSky = require('./sky.js');

    var getPipe = require('./pipe.js');

    var getLand = require('./land.js');

    var getBird = require('./bird.js');
    ...
    var getGameScene = function(option) {
        return new Scene(option);
    }

    // 将 new Scene(option)通过module.exports暴露
    // 给draw.js使用
    module.exports = getGameScene;
