define(function(require, exports, module) {
    ...
    // 组合成一个场景
    var getCreateScene = require('./chagneScene.js');

    // 需要引入各个图形的构造函数来实例化图形
    var getHistogramChart = require('./littleFn/histogramChart.js');

    var getPieChart = require('./littleFn/pieChart.js');

    var getProgressBar = require('./littleFn/progressBar.js');

    var getRingScene = require('./littleFn/ringSecne.js');
    ...
    // 触摸或者鼠标移动事件
    var addSceneChangeEvent = require('./addSceneChangeEvent.js');
    ...
    // 这是需要加载的图片
    var loadImgs = ['green.jpg',
        'light.png', 'bg.jpg', 'light-color.png', 'little5.png', 'text.png'
    ];
    ...
    function ringScene() {
        ...
        // 圆环的最大宽度
        ringRadius = 2 / 3 * (stage.getWidth() > stage.height() ? stage.height():stage.getWidth());


        return getCreateScene({
            name: '场景2',
            stage: stage,
            layers: [bgLayer, lightLayer],
            init: function() {
                var self = this;
                // 将对象分别放入各自对应的层中
