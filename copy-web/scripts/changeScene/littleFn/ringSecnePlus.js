(function(win){
    ...
    function RingScene(option) {
        ...
        this.cenX = option.cenX || this.stage.getWidth() / 2;
        this.cenY = option.cenY || this.stage.getHeight() / 2;
    ...
    RingScene.prototype = {
        ...
        _init: function() {
            ...
            // 这里创建一个大组，将所有组成场景的对象包裹起来
            this.bigGroup = new Konva.Group({
                x: 0,
                y: 0,
            ...
            //    将圆形添加到背景层中
            L1Circle_web.addToGroupOrLayer(bgGroup);




            //创建一个动画层
            this.animateGroup = new Konva.Group({
                x: 0,
                y: 0
            });
            this.bigGroup.add(this.animateGroup);
            ...
            this.animateGroup.add(this.L2Group);
            ...
            this.animateGroup.add(this.L3Group);
        ...
        addToGroupOrLayer: function(arg) {
            arg.add(this.bigGroup);
        },

        // 封装一个让小圆围绕圆环转动的函数，使用konva的animate
        // 动画系统
        playAnimation: function(animationLayer) {
            ...
            //    这里是this.animateGroup层中的元素做动画。所以将该层传入。
        ...
        // 停止动画；当鼠标移开的时候，开始动画
        addMouseEvent: function(animationLayer) {
            ...
            animationLayer.on("mouseover", function() {
                this.rotateAnglePerSecond = 0;
            });


            //   鼠标离开的时候，该层上所有元素的旋转速度恢复正常
            animationLayer.on("mouseout", function() {
                this.rotateAnglePerSecond = 60;
            });

        }
    }

    var getRingScene = function(option) {

        return new RingScene(option);
    };

    win.getRingScene = getRingScene;
