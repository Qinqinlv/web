...
// 下面是flappyBird锚点数据
  var flappyFiles = [
        ...
        './scripts/flappyBird/js/drawScene.js',
...
// 下面是Scene锚点数据
 var sceneFiles = ['./scripts/changeScene/chagneScene.js',
        './scripts/changeScene/littleFn/histogramChart.js',
        './scripts/changeScene/littleFn/pieChart.js',
        './scripts/changeScene/littleFn/progressBar.js',
        './scripts/changeScene/littleFn/ringFn.js',
        './scripts/changeScene/littleFn/ringSecnePlus.js',
...
var waterfallFiles = [
    './scripts/waterfall/js/waterfallPlus.js',
...
// 这是主轮播图的数据
var carouselFiles = [
    './scripts/carousels/css3Carousel2-6/js/css3Carousel2.js',
    './scripts/carousels/floatNav/js/floatNav.js'
...
var carouselCss2 = [
    './scripts/carousels/css3Carousel1-4/js/css3Carousel1.js',
    './scripts/carousels/floatNav/js/floatNav.js'
...
// 这是第3个轮播图css3Carousel1-4的数据
var carouselJS1 = [
    './scripts/carousels/carouselJS1-6/js/animate.js',
    './scripts/carousels/carouselJS1-6/js/carouselJS1.js',
    './scripts/carousels/floatNav/js/floatNav.js'
...
// 这是第4个轮播图css3Carousel1-4的数据
var carouselJS2 = [
    './scripts/carousels/carouselJS2-5/js/carouselJS2.js',
    './scripts/carousels/floatNav/js/floatNav.js'
];
...
// 鼠标进入、离开的方向有关
var mouseInOrOut = [
    './scripts/carousels/mouseInOrOut/js/mouseInOrOut.js',
    './scripts/carousels/floatNav/js/floatNav.js'
];
