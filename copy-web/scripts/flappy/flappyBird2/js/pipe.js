(function(win){
    ...
    function Pipe(option) {
        ...
        // 上管道的宽高
        this.pipeUpW = option.pipeUpw || this.pipeUp.width;
        this.pipeUpH = option.pipeUpH || this.pipeUp.height;

        // 下管道的宽高
        this.pipeDownW = option.pipeDownW || this.pipeDown.width;
        this.pipeDownH = option.pipeDownH || this.pipeDown.height;
    ...
    Pipe.prototype = {
        ...
        _drawPath: function() {
            ...
            // 给上管道绘制描边矩形。
            this.ctx.rect(this.pipeX, 0, this.pipeUpW, this.upHeight);
